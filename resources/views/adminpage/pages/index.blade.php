...
<div class="row purchace-popup">
    <div class="col-12">
        <span class="d-block d-md-flex align-items-center">
            ...
            <a class="btn ml-auto download-button d-none d-md-block" href="https://github.com/BootstrapDash/StarAdmin-Free-Bootstrap-Admin-Template"
                ...
                <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                        ...
                        <div class="ticket-details col-md-9">
                            ...
                            <p class="text-gray ellipsis mb-2">Donec rutrum congue leo eget
                            ...
                            <div class="row text-gray d-md-flex d-none">
                                <div class="col-4 d-flex">
                                    ...
                                    <small class="Last-responded mr-2 mb-0 text-muted text-muted">3
                                        hours ago</small>
                                </div>
                                <div class="col-4 d-flex">
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                        ...
                        <div class="ticket-details col-md-9">
                            <div class="d-flex">
                                ...
                                <p class="mb-0 ellipsis">Curabitur aliquet quam id dui posuere
                                    blandit.</p>
                            </div>
                            <p class="text-gray ellipsis mb-2">Pellentesque in ipsum id orci porta
                    ...
                    <div class="row ticket-card mt-3">
                        ...
                        <div class="ticket-details col-md-9">
                            <div class="d-flex">
                                ...
                                <p class="mb-0 ellipsis">Mauris blandit aliquet elit, eget
                                    tincidunt nibh pulvinar.</p>
                            </div>
                            <p class="text-gray ellipsis mb-2">Nulla quis lorem ut libero malesuada
