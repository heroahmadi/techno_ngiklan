    ...
    <div class="container">
        <div class="row d-flex">
            <div class="menu-content pb-70 col-lg-8">
                <p>Menampilkan 16 dari {{ $produk->total() }}</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="single-popular-carusel col-lg-3 col-md-6">
                <div class="thumb-wrap relative">
                    <div class="thumb relative">
                        <div class="overlay overlay-bg"></div>
                        <img class="img-fluid" src="{{ asset('storage/produk/iphone.png') }}" alt="">
                    </div>
                    <div class="meta d-flex justify-content-between">
                        <p><span class="lnr lnr-users"></span> {followers} <span class="lnr lnr-bubble"></span> gatau</p>
                        <h4>{gatau}</h4>
                    </div>
                </div>
                <div class="details">
                    <a href="{{ url('endorser/'.$item->id) }}">
                        <h4>
                            {{ $item->nama_produk }}
                        </h4>
                    </a>
